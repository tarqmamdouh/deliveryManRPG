    ...
    class Road < LevelArea
      ...
      def stay_still
        Combat.new(@adventurer, @monster, true) do
          @adventurer.character.damage(10,
                                       'You made a perfect choice, but your mobile rang, snake attacked you')
        end
        GameMenu.select('Nothing else, its a dead end. What are you going to do', {
                          "Back to the cave enterance": method(:explore_right),
                          "Back to the road": method(:start)
      ...
      def run
        Combat.new(@adventurer, @monster, true) do
          @adventurer.character.damage(25,
                                       'Running is the last thing you can do when you face a snake, snake attacked you')
        end
        GameMenu.select('Nothing else, its a dead end. What are you going to do', {
                          "Back to the cave enterance": method(:explore_right),
                          "Back to the road": method(:start)
